...
public class PatientsUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PatientsUI frame = new PatientsUI();
	...
	public PatientsUI() {
		...
		tablePatients = new JTable(new PatientsAdapter());
